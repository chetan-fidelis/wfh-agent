...
The Download Monitor is a lightweight feature that automatically detects and uploads Naukri CV files downloaded by recruitment-related employees to a Laravel API endpoint (`http://ats-tool.test/api`).
